...
Fork qm. This repository is a copy of the qm working tree at `7f2c916`, and Company Brain is built
inside it.
...
- **No upstream merges.** The copy was taken from a working tree, so this repository shares no
  commits with qm. Pulling upstream fixes means diffing trees by hand.
